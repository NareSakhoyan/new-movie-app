           ...
           <div class="box column is-8 is-offset-2 ">
               <article class="media">
                   <div class="media-left">
                       <figure class="image">
                           <img :src="getImgUrl(movieDetails.poster_path)" alt="...">
                       </figure>
                   </div>
                   <div class="media-content">
                       <div class="content">
                           <div class="tile is-ancestor is-marginless">
                               <div class="tile is-11 is-vertical">
                                    <div class="tile">
                                        <a :href="`${movieDetails.homepage}`"><p class="title">{{movieDetails.title}}</p></a>
                                    </div>
                                    <div class="tile">
                                        <span><time :datetime="movieDetails.release_date" >({{movieDetails.release_date}})</time></span>
                                    </div>
                               </div>
                               <div class="tile is-1">
                                   <figure class="image" v-if="loggedIn">
...
<!--                                   <img src="../assets/bookmarked.jpg" alt="bookmark" class="bookmarkImg" @click="bookmarkClick">-->
                           ...
                           <p class="subtitle is-6 has-text-weight-light"><i>{{movieDetails.tagline}}</i></p>
                           <p class="is-6">{{movieDetails.overview}}</p>
                           <b-field label="Genres: ">
                               <p class="is-6">{{getNames(movieDetails.genres, 'genres')}}</p>
                           </b-field>
                           <b-field label="Production Companies: ">
                               <p class="is-6">{{getNames(movieDetails.production_companies, 'prodComp')}}</p>
                           </b-field>
                           <b-field label="Popularity: ">
                               <b-progress :value="movieDetails.popularity" :max='1000' size="is-medium" show-value>
